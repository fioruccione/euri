...
## Architettura Cognitiva (stato corrente)
...
>
> **Fotografia storica della release V2.22:** [Memoria osservabile e confinata](docs/EURI_V2.22_STATE_2026-07-30.md)
...
- Le scritture generate da Euri vengono riconosciute anche quando writer e Watcher sono processi diversi: il corpo Markdown canonico viene confrontato con Redis e, se è identico, non causa embedding, riscritture o falsi eventi Pulse. Solo una modifica umana reale rientra come percezione `vault/extero/change`.
...
- **Stessa cosa in Silent Chat:** il frame semantico può riconoscere anche una formulazione naturale come una correzione seguita da *“ricordalo”*, senza richiedere la formula esatta *“memorizza questo”*. Il canale usa lo stesso coordinatore della voce, salva prima di rispondere e costruisce la conferma dall'esito reale. Un fatto già presente soltanto come memoria passiva viene promosso a `source=user`, non scambiato per un duplicato autorevole.
