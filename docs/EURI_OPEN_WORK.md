...
| DOC-01 | P1 | implementato offline, 92/92 unit, live aperto | il caso Yizumi/CEN ha mostrato upload 2/2 ma lettura effettiva 1/2: il controller perdeva i nomi e `read_document` riduceva più estrazioni al solo file attivo; una successiva frase CHAT ha dichiarato una lettura clipboard mai avvenuta | dopo riavvio caricare insieme due offerte distinte e chiedere un confronto; poi ripetere con una copia duplicata o un file volutamente illeggibile | UI mostra ricevuta 2/2 con nomi e hash distinti; risposta attribuisce ogni dato alla fonte; su 1/2 o hash duplicato nessun confronto, operazione fallita e nessuna dichiarazione di lettura priva di tool |
