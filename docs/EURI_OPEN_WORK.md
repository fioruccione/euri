...
| COG-02 | P1 | bloccato da COG-01 | structured v2: contratto 76/76 e zero false supersessioni, ma recall vero 50%; `NO_GO_DEV` | solo dopo COG-01, progettare un v3 con challenge nuovo; possibile OR fra correzione esplicita e incompatibilità verificata | batte il legacy sui gate congelati senza riuso del challenge v2 come validazione |
